...
if(isset($_REQUEST['delete'])) {
	$query=mysqli_query($con,"delete from  tbladmin  where id='".$_REQUEST['delete']."'");
...
<td> 
	<a href="manage-admin.php?delete=<?php echo $row['id'];?>"> <i class="fa fa-trash" style="color: #f05050"> </i></a> </td>
</tr>
<?php
$cnt++;
 } ?>
